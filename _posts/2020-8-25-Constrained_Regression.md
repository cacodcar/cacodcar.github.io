...
Here is how I solved this using Python 3.7 and numpy. Since numpy is quite fast, a problem with 20 constraints and $x\in\mathcal{R}^{100}$ took  on average 0.15 seconds to solve on my desktop.
